    ...
    return(
      <div className="row">
        <div className="col s4 push-s2">
          ...
          <br />
          <br />
          <center><h3 className="light italic"> My Profile </h3>
          <img style={{width: "200px"}} src="images/blank.png" /></center>  
          <div>
            <center><p className="center light italic"><b>Screen Name:</b> {this.props.screenname} <br/>
            <b>Talent:</b> {this.props.talent}<br/>
            <b>Zip Code:</b> {this.props.zipcode}<br/>
            <b>Talent Background:</b> <br />
                {this.props.bio}<br/>
            </p></center>
            <center><a href="#" className="amber-text text-darken-1"><i className="tiny material-icons amber-text text-darken-1">comment</i> Comments</a><br/>
            <a href="#" className="amber-text text-darken-1"><i className="tiny material-icons amber-text text-darken-1">thumb_up</i> Likes {this.props.likes} </a><br/>
            <button className="btn yellow darken-2">Edit My Profile</button></center>
          </div>
        </div>
        <div className="col s4 push-s2">
          <center><h3 className="light italic">Live View</h3>
