         ...
         <div className="row">
          <div className="col m5 pull-m1">
            ...
            <ul style={{paddingTop:"15px"}}>
              <li style={{fontSize:"20px"}}><i className="medium material-icons light italic">search</i> Explore New Talents</li><br/>
              <li style={{fontSize:"20px"}}><i className="medium material-icons light italic">mode_edit</i> Customize Your Interests & Experience</li><br/>
              <li style={{fontSize:"20px"}}><i className="medium material-icons light italic">person_pin</i> Connect With People In Your Area</li>    
            </ul>
          </div>
